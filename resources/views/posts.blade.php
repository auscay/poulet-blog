    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 order-lg-2 pb-6 pb-lg-0">
                ...
                <div class="mb-8">
                    <h2 class="mb-4 text-uppercase"><a href="../pages/blog-single.html" class="text-body">{{$post->title}}</a></h2>
                    <p class="text-700 fw-medium">{{$post->pretext}}</p>
                    <div class="mt-4 d-flex justify-content-between">
                        <div class="w-50">
                            <img src="img/profiles/profile-thumbnal-01.jpg" alt="" class="rounded-circle float-start me-2" width="40" height="40" />
                            <p class="fs--1 lh-13 text-700">{{$post->author}}<br /><span class="fs--3">{{$post->created_at}}</span></p>
                        </div>
                        <a href="../pages/blog-single.html" class="h6 fw-bold text-uppercase text-primary pt-3">Read more<i class="zmdi zmdi-chevron-right ps-4"></i></a>
                    </div>
                </div>
