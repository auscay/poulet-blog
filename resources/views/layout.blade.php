...
<html lang="en">
    ...
    <body>
        ...
        <header class="spyre-navbar navbar navbar-expand-lg bg-secondary navbar-dark fixed-top align-items-center" data-transparent data-text-color="#ffffff">
            <div class="container">
                <a class="navbar-brand me-lg-5 me-xl-7" href="../pages/index.html">
                    <img src="img/logo.png" class="d-none d-lg-block" alt="Spyre" width="183" />
                    <img src="img/logo.png" class="d-block d-lg-none" alt="Spyre" width="150" />
                </a>
        ...
        <section class="py-0 overflow-hidden text-center">
            <div class="bg-container overlay parallax" data-rellax-percentage="0.5" style="background-image: url(img/backgrounds/bg-02.jpg)">
                <div class="bg-video vimeo" data-property="{videoURL:'https://vimeo.com/159035843', stopAt:45, autoPlay:true, mute:true, showControls: false, containment: 'self', loop: false}"></div>
            </div>
            <div class="container">
                <div class="row h-100vh align-items-center">
                    <div class="col position-relative">
                        <h1 class="text-white text-uppercase fs-4 fs-lg-6">Media, Tech and Business</h1>
                    </div>
                </div>
            </div>
        </section>
